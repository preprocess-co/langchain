...
### You can use PreprocessLeader to load your file 
You can initialise PreprocessLeader with a filepath and Preprocess SDK will connect with the system with your API Key and convert and chunk it for you 

```python
from langchain.document_loaders import PreprocessLeader

path = "your/dir/path"
loader = DirectoryLoader(path, loader_cls=PreprocessLeader، loader_kwargs={"api_key": "YOUR_API_KEY..."})
loader.load()

```

Or if you already called PreprocessLoader and have a process_id you can pass it instead of filepath and call load
...
path = "your/dir/path"
loader = DirectoryLoader(path, loader_cls=PreprocessLeader، loader_kwargs={"api_key": "YOUR_API_KEY...", "process_id": "YOUR_PROCESS_ID..."})
loader.load()
